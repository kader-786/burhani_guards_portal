...
//                 if (userRoleId === '2') {
//                     // Allowed: Store user data and tokens in sessionStorage
//                     storeUserSession(result.data, result.tokens);
                    
//                     // Navigate to dashboard
//                     routeChange();
//                 } else {
//                     // Not Allowed: Show authorization error
//                     setError("Not Authorized: You do not have permission to access this application.");
//                     // We do NOT store session data here
//                 }
...
//         const isLoggedIn = sessionStorage.getItem('isLoggedIn');
//         const sessionExpiry = sessionStorage.getItem('session_expiry');
//         // Also check stored role_id on auto-login (optional safety check)
//         const storedRoleId = sessionStorage.getItem('role_id');
        
//         if (isLoggedIn && sessionExpiry && storedRoleId === '2') {
//             const currentTime = Date.now();
//             const expiryTime = parseInt(sessionExpiry, 10);
...
//                 routeChange();
//             }
//         } else if (isLoggedIn && storedRoleId !== '2') {
//             // If somehow logged in but wrong role, clear session
