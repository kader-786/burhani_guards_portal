...
export const MenuItems = [
  ...
  },
  {
    ...
    type: 'sub', active: false, selected: false, title: 'Reports', children: [
      { path: `${import.meta.env.BASE_URL}reports/attendancereport`, type: 'link', active: false, selected: false, title: 'Attendance Report' },
      { path: `${import.meta.env.BASE_URL}reports/dutiesallotedbackoffice`, type: 'link', active: false, selected: false, title: 'Duties Allotted - Backoffice' },
      { path: `${import.meta.env.BASE_URL}reports/dutiesallotedmumbai`, type: 'link', active: false, selected: false, title: 'Duties Allotted - Mumbai' },
      { path: `${import.meta.env.BASE_URL}reports/dutiesallotedmarol`, type: 'link', active: false, selected: false, title: 'Duties Allotted - Marol' },
      { path: `${import.meta.env.BASE_URL}reports/dutiesallotedmumbra`, type: 'link', active: false, selected: false, title: 'Duties Allotted - Mumbra' },
    ]
  },
];