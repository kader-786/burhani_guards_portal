...
//             {/* UPDATED HEADER - Uses shared-styles.css */}
//             <div className="page-header-title">
//                 <div className="header-text">
//                     <i className="ri-file-list-3-line"></i>
//                     <span>Duties Assign</span>
//                 </div>
//                 {isEditMode && (
//                     <span className="edit-mode-badge">
//                         <i className="ri-edit-line me-1"></i>
...
//                     {/* Save and Cancel/Clear Button Row */}
//                     <div className="button-row">
//                         {isEditMode ? (
//                             <>
//                                 <button 
...
const MiqaatTeamForm = () => {
    ...
    // Calculate effective remaining quota
    const getEffectiveRemainingQuota = () => {
        if (remainingQuota === null) return null;
        return isEditMode ? remainingQuota + originalQuota : remainingQuota;
    };

    // Fetch Miqaat on component mount
    useEffect(() => {
        fetchMiqaatOptions();
    }, []);
                    ...
                    <Col xl={12}>
                        <Card className="custom-card">
                            <Card.Body>
                                ...
                                {/* Show form sections after miqaat selected */}
                                {showFormSections && (
                                    <>
                                        {/* Row 2: Jamiaat and Team */}
                                        <div className="two-column-row">
