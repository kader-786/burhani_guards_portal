...
// // // MiqaatIncharge.jsx - COMPLETE FILE
// // import React, { useState, useEffect, Fragment } from 'react';
// // import { Card, Col, Row } from 'react-bootstrap';
// // import Select from 'react-select';
// // import Swal from 'sweetalert2';
...
// //     // Incoming miqaat from navigation
// //     const [incomingMiqaat, setIncomingMiqaat] = useState(null);
// //     const [showInfoBanner, setShowInfoBanner] = useState(false);
// //     const [miqaatInfo, setMiqaatInfo] = useState(null);
// //     const [loadingMiqaatInfo, setLoadingMiqaatInfo] = useState(false);
...
// //     // Check if time is default/empty (00:00:00 or null)
...
// //     // Extract location reporting time from map
// //     const getLocationReportingTime = (locationId) => {
// //         return locationReportingTimeMap[locationId] || null;
// //     };

// //     // Build location reporting time map from incharges data
...
// //         // Check if location has existing reporting time
// //         if (selectedOption?.value) {
// //             const existingTime = getLocationReportingTime(selectedOption.value);

// //             if (existingTime && !isEditMode) {
// //                 // Location has reporting time and we're in INSERT mode
// //                 const time24 = existingTime.split(':').slice(0, 2).join(':');
// //                 setFormData(prev => ({ ...prev, reportingTime: time24 }));
// //                 setIsReportingTimeDisabled(true);
// //             } else {
// //                 // No existing time OR we're in EDIT mode (always enabled)
// //                 setIsReportingTimeDisabled(false);
// //             }
// //         } else {
// //             setIsReportingTimeDisabled(false);
...
// //                     // Determine message based on result code
...
// //                         setTimeout(() => handleCancel(), 2000);
// //                     } else {
// //                         setFormData(prev => ({ ...prev, member: null, reportingTime: '' }));

// //                         // Reset reporting time based on location
...
// //             // In EDIT mode, reporting time is ALWAYS enabled
// //             setIsReportingTimeDisabled(false);
...
// // MiqaatIncharge.jsx - COMPLETE UPDATED FILE
// import React, { useState, useEffect, Fragment } from 'react';
// import { Card, Col, Row } from 'react-bootstrap';
// import Select from 'react-select';
// import Swal from 'sweetalert2';
...
//             console.log('Location changed to:', selectedOption.value, 'Existing time:', existingTime);
...
//                 setFormData(prev => ({ ...prev, reportingTime: time24 }));
//                 setIsReportingTimeDisabled(true);
//                 console.log('Reporting time set to:', time24, 'Disabled: true');
//             } else {
//                 // No existing time OR we're in EDIT mode (always enabled)
//                 setIsReportingTimeDisabled(false);
//                 console.log('No existing time or edit mode. Disabled: false');
//             }
//         } else {
//             setIsReportingTimeDisabled(false);
//         }
...
//                         setTimeout(() => handleCancel(), 2000);
//                     } else {
//                         // For INSERT mode, keep location and its reporting time
//                         setFormData(prev => ({
//                             ...prev,
//                             member: null
//                             // Keep reportingTime as is - it will be managed by handleLocationChange
//                         }));

//                         // Re-apply location logic to update reporting time state
//                         if (formData.location?.value) {
//                             // Wait for incharges to be fetched and map to be built
//                             setTimeout(() => {
//                                 const existingTime = getLocationReportingTime(formData.location.value);
//                                 console.log('After save - existing time for location:', existingTime);

//                                 if (existingTime) {
//                                     const time24 = existingTime.split(':').slice(0, 2).join(':');
//                                     setFormData(prev => ({ ...prev, reportingTime: time24 }));
//                                     setIsReportingTimeDisabled(true);
//                                     console.log('Updated reporting time after save:', time24);
//                                 } else {
//                                     setIsReportingTimeDisabled(false);
//                                 }
//                             }, 100);
